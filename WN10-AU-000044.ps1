...
.USAGE
    ...
    Example syntax:
    PS C:\> .\__remediation_template(STIG-ID-WN10-AU-000044).ps1 
#>
...
Write-Output "NC_ShowSharedAccessUI has been set to $RegValue. Please restart the system or run 'gpupdate /force' for changes to take effect."
